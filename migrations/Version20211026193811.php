 ...
 */
final class Version20211026193811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7F722EF037425303 ON servant_info');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE servant_info_user (servant_info_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_27BDF7056689AFA3 (servant_info_id), INDEX IDX_27BDF705A76ED395 (user_id), PRIMARY KEY(servant_info_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE INDEX IDX_7F722EF037425303 ON servant_info (servant_id_id)');
    }
}
